...
// Read metrics & csv
const metrics = JSON.parse(fs.readFileSync('PHASE_6C_METRICS.json', 'utf8'));
...
const remainingP0 = p0List.filter(a => !enrichedSet.has(a.path));

const mdContent = `# PHASE 6C — REMAINING THIN-CONTENT RECONCILIATION AUDIT
...
| **Total Indexable** | **1,121** | **100.0%** | Healthy bell-curve distribution centered around 200–400w |
...
fs.writeFileSync('PHASE_6C_THIN_CONTENT_RECONCILIATION.md', mdContent, 'utf8');
console.log('Saved PHASE_6C_THIN_CONTENT_RECONCILIATION.md');
