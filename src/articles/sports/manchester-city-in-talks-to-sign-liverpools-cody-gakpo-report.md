...
video_caption: "ด่วน! กัคโป ปัดสเปอร์สเลือกย้ายซบ แมนซิตี้ 85 ลป.! ลิเวอร์พูล ลุยหาตัวแทนโค้งสุดท้าย #ข่าวลิเวอร์พูล"
videos:
  - video_id: "rOB4E-HFUOg"
    title: "ด่วน! กัคโป ปัดสเปอร์สเลือกย้ายซบ แมนซิตี้ 85 ลป.! ลิเวอร์พูล ลุยหาตัวแทนโค้งสุดท้าย #ข่าวลิเวอร์พูล"
    channel: "กัปตัน เวอร์จิล"
  - video_id: "qOLcyteJqTY"
    title: "talkSPORT REVEAL LATEST on Endrick to Arsenal, Cody Gakpo to Spurs, Enzo Fernandez&#39;s future &amp; MORE!"
    channel: "talkSPORT"
  - video_id: "5Sb70elxvlo"
    title: "Fabrizio Romano announced the signing of Cody Gakpo!"
    channel: "Random Football News Today"
slug: "manchester-city-in-talks-to-sign-liverpools-cody-gakpo-report"
sourceUrl: "https://www.newsbytesapp.com/news/sports/gakpo-is-of-interest-to-manchester-city-this-summer-window/story"
...
Liverpool, meanwhile, are weighing the financial return against the loss of a key attacking asset. Sources indicate the Merseyside side expects a six‑figure pound fee, reflecting Gakpo’s market value after a strong campaign, while also considering a sell‑on clause to protect future earnings.

If the deal proceeds, Gakpo could join a City squad already featuring a deep pool of forwards, potentially rotating with Erling Haaland and Phil Foden. The transfer would also free up wage budget for City and allow Liverpool to reinvest in emerging talent or a strategic replacement in the striker’s role.
