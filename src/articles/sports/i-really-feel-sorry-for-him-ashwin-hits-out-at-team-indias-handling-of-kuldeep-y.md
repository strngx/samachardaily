...
imageAlt: "Cricket ball and equipment placed on a cricket ground pitch."
imageCredit: "Patrick Case (via Pexels)"
...
why_it_matters: |
  Kuldeep Yadav’s limited exposure in Tests raises broader questions about India’s spin‑selection strategy. With the team gearing up for upcoming tours in spin‑friendly conditions, such as the West Indies and England, the inclusion of a wrist‑spinner could diversify the attack and exploit variations that traditional off‑spinners cannot. Moreover, Ashwin’s public criticism underscores internal concerns about talent management; ignoring a bowler’s confidence can affect performance and morale across the squad. The board’s response will signal whether it values short‑term results over long‑term development of a versatile spin pool.
  
  If the selectors decide to back Kuldeep with a sustained run, it could rejuvenate his career and provide India with a potent weapon in both home and overseas Tests. Conversely, continued neglect may push the bowler to focus solely on limited‑overs cricket, potentially depriving the Test side of a unique skill set. The next selection window, ahead of the series against England, will likely reveal the board’s stance on this issue.
---
Ravichandran Ashwin, one of India’s most experienced Test spinners, opened up about the plight of fellow wrist‑spinner Kuldeep Yadav after the latter’s sparse involvement in the longest format. Speaking to the media following India’s recent Test series, Ashwin said, “I really feel sorry for him,” referring to Kuldeep’s lack of opportunities despite his proven record in limited‑overs cricket. The veteran highlighted that Kuldeep, who has been a regular feature in India’s ODI and T20I squads, has featured in only a handful of Tests, leaving his confidence “at an all‑time low.”
